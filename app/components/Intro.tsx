      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
          <p className="text-lg">
            ...
            <br />
            <br />
            We’re all about community! The Puzzle Dogs family isn’t just me.
            It’s an entire group of people who are all obsessed with our dogs!
            <br />
            <br />
            <span className="font-bold">Mission:</span>
            <br />
            To breed easy-to-live-with, social, happy, healthy, “dog-shaped”
            dogs who can be successful at a hobby level in a variety of sports
            with a novice handler, and who will live comfortably into their
            mid-late teens.
            <br />
            <br />
          </p>
        ...
        <img src="/images/sara.jpg" className="rounded-sm shadow" />
      </div>
